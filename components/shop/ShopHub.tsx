  ...
  return (
    <div>
      <Section tone="dark" className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-10 pt-14 sm:px-8 sm:pt-20">
            ...
            {DEPARTMENTS.map((d, index) => {
              ...
              return (
                <Link
                  key={d.id}
                  href={d.href}
                  className="shop-fade-up group relative flex min-h-[220px] overflow-hidden rounded-sm border border-gold-400/25 bg-ink text-bone transition-[border-color,transform] duration-500 hover:-translate-y-1 hover:border-gold-400/55 sm:min-h-[260px]"
