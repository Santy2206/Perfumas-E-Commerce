...
export default function ListasPage() {
  ...
  if (!customer) {
    return (
      <Section tone="light" className="min-h-[50vh]">
        <div className="mx-auto max-w-3xl px-4 py-12 sm:px-8">
          <h1 className="font-display text-3xl text-ink mb-4">Mis listas</h1>
  ...
  return (
    <Section tone="light" className="min-h-[50vh]">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-8">
        <h1 className="font-display text-3xl text-ink mb-2">Mis listas</h1>
          ...
          <div className="space-y-4">
            {lists.map((list) => {
              ...
              return (
                <div
                  key={list.id}
                  className="rounded-sm border border-gold-400/25 bg-white p-4"
                >
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    >
                      <p className="font-display text-xl text-ink">{list.name}</p>
